...
class QQWry extends \Wei\Base{
	...
	public function __construct(){
		$file = BASE_PATH .'config/qqwry.dat';
	...
	public function query($ip){
		...
		return implode(' ', $this->read_record($ip_record_offset));
	}
	...
	public function read_record($offset){
		...
		$record[0] = iconv('GB2312', 'UTF-8//IGNORE', $record[0]);
		$record[1] = iconv('GB2312', 'UTF-8//IGNORE', $record[1]);
